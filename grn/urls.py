...
urlpatterns = [
    ...
    path(
        "grn-details/",
        login_required(views.GrnDetailView.as_view()),
        name="grn-details",
    ),
    ...
    path(
        "stocks/out/details/",
        login_required(views.StockDetailsView.as_view()),
        name="stock-details",
    ),
    path(
        "stock/return/<int:stock_out_id>/",
        login_required(views.StockReturnView.as_view()),
        name="stock-return",
    ),
]
